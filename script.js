...
function renderContesto() {
  ...
  document.getElementById("Filo").innerHTML = `
    <p style="text-align: center;">
    1) Intro: si apre il sipario a voi l'orizzonte degli eventi!<br><br>
2) Perché: l'animo puro depone le armi, l'ipocrisia del mondo lo ha confuso.<br><br>
3) Memoria: l'amico gli ricorda il cammino.<br><br>
4) Abito: dal desiderio all'amore unico.<br><br>
5) Invito: l'infinito ama, torna ed invita.<br><br>
6) Azione: tra il fare e il non fare c'è l'essere nell'Essere.<br><br>
7) Uguale: nel piccolo luogo del corpo la palestra e il tempio della visione divina.<br><br>
8) Sofia: ciò che transita, ciò che resta... qualcuno salta.<br><br>
9) Vero: il vivo riflette il vero e il cammino si illumina.<br><br>
10) Radici: dall'uno, dall'altra, dall'unico.</p>`;
}
